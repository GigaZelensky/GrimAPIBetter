...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double lengthSquared() {
        return MathUtil.square(this.x) + MathUtil.square(this.y) + MathUtil.square(this.z);
    }

    public double distance(@NotNull Vector3dm o) {
        return Math.sqrt(MathUtil.square(this.x - o.x) + MathUtil.square(this.y - o.y) + MathUtil.square(this.z - o.z));
    }

    public double distanceSquared(@NotNull Vector3dm o) {
        return MathUtil.square(this.x - o.x) + MathUtil.square(this.y - o.y) + MathUtil.square(this.z - o.z);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return MathUtil.square(origin.x - this.x) + MathUtil.square(origin.y - this.y) + MathUtil.square(origin.z - this.z) <= MathUtil.square(radius);
    }
    ...
    public int getBlockX() {
        return MathUtil.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return MathUtil.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return MathUtil.mojangFloor(this.z);
    }
